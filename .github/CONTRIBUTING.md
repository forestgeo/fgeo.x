# Contributing to fgeo.x

This outlines how to propose a change to __fgeo.x__. For more detailed info about contributing to this, and other __fgeo__ packages (<https://forestgeo.github.io/fgeo/>), please see the [**development contributing guide of the tidyverse**](https://rstd.io/tidy-contrib) (wherever you read __tidyverse__ think __fgeo.x__).
...
See tidyverse [development contributing guide](https://rstd.io/tidy-contrib) for further details (wherever you read __tidyverse__ think __fgeo.x__).
